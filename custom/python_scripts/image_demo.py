...
def parse_args():
    ...
    parser.add_argument(
        ...
        default='configs/pretrain/yolo_world_v2_l_vlpan_bn_2e-3_100e_4x8gpus_obj365v1_goldg_train_1280ft_lvis_minival.py'
    )
    parser.add_argument(
        'checkpoint',
        help='checkpoint file',
        default='models/yolo_world_v2_l_obj365v1_goldg_pretrain_1280ft-9babe3f6.pth'
    )
    parser.add_argument(
        'image',
